...
import com.example.classapp.Fragments.dummy.DummyContent.DummyItem
import com.example.classapp.RivalManager

/**
 * A fragment representing a list of Items.
 * Activities containing this fragment MUST implement the
 * [ChampFragment.OnListFragmentInteractionListener] interface.
 */
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyItemRecyclerViewAdapter(RivalManager.rivalList(), listener)
